              ...
              >
                <motion.div className="space-y-4" variants={fadeInUp}>
                  ...
                  <div className="text-xl md:text-2xl lg:text-3xl font-light text-black mt-4 md:mt-8">
                    It's all about the{" "}
                    <span className="font-normal">Celebrations</span> of
                ...
                >
                  ...
                  is a commitment we hold dear, ensuring they experience the joy
                  and warmth of memorable childhood birthday celebrations. In
                  this way, we contribute to a crucial part of their childhood
                  memories, making us an integral part of their lives.
                </motion.p>
              </motion.div>
