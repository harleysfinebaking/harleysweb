...
export function Header5({ isScrolled }: { isScrolled: boolean }) {
    ...
    <header className="fixed top-0 left-0 right-0 z-50">
        ...
        <div className="container mx-auto px-4 py-2 md:py-4">
          ...
          <nav className="hidden md:flex justify-between items-center">
            <div className="flex space-x-6 items-center">
              <Link href="#about" className={`hover:text-[#d45770] transition-colors text-lg ${isScrolled ? 'text-[#4A4A4A]' : 'text-transparent'}`}>About</Link>
            ...
            <div className="flex space-x-6 items-center">
              ...
              <Link href="#contact" className={`hover:text-[#d45770] transition-colors text-lg ${isScrolled ? 'text-[#4A4A4A]' : 'text-transparent'}`}>Contact</Link>
            </div>
          </nav>
        </div>
      </div>
      ...
      <style jsx>{`
        .brick-pattern {
          ...
          background-image: 
            linear-gradient(335deg, rgba(255, 255, 255, 0.8) 23px, transparent 23px),
            linear-gradient(155deg, rgba(255, 255, 255, 0.8) 23px, transparent 23px),
            linear-gradient(335deg, rgba(255, 255, 255, 0.8) 23px, transparent 23px),
            linear-gradient(155deg, rgba(255, 255, 255, 0.8) 23px, transparent 23px);
