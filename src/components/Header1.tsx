...
export function Header1() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className={`bg-[#FEFEFA] transition-all duration-300 ${showMarquee ? '' : 'shadow-md'}`}>
        <div className="container mx-auto px-4 py-2 md:py-4">
          ...
          <nav className="hidden md:flex justify-between items-center">
            <div className="flex space-x-6 items-center">
              <Link href="#about" className="text-[#4A4A4A] hover:text-[#d45770] transition-colors text-lg">About</Link>
              <Link href="#menu" className="text-[#4A4A4A] hover:text-[#d45770] transition-colors text-lg">Menu</Link>
            </div>
            <Link href="/" className="mx-6 transform -translate-y-2">
              <Image src="/logo.png" alt="Harley's" width={200} height={200} className="w-40 h-auto" />
            </Link>
            <div className="flex space-x-6 items-center">
              <Link href="#locations" className="text-[#4A4A4A] hover:text-[#d45770] transition-colors text-lg">Locations</Link>
              <Link href="#contact" className="text-[#4A4A4A] hover:text-[#d45770] transition-colors text-lg">Contact</Link>
            </div>
          </nav>
        </div>
      </div>
