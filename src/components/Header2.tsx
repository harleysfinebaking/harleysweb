...
export function Header2() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className={`transition-all duration-300 ${isScrolled ? 'bg-[#FEFEFA] shadow-md' : 'bg-transparent'}`}>
        <div className="container mx-auto px-4 py-2  md:py-4">
          <div className="flex justify-between items-center md:hidden">
            <Link href="/" className="text-2xl font-bold text-[#4A4A4A]">
              <Image src="/logocircle/logosnew/logonew-black-tran.png" alt="Harley's" width={200} height={200} className="w-24 h-auto" />
            </Link>
